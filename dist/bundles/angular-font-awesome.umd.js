(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : factory(
        (global.angularFontAwesome = global.angularFontAwesome || {}),
        global.ng.core
      );
  ...
  var AngularFontAwesomeComponent = (function () {
    ...
    AngularFontAwesomeComponent.prototype.ngOnInit = function () {
      if (!this.name) {
        throw new Error(
          'Missing "name" property for Angular2 Font Awesome component'
        );
      }
      if (this.size) {
    ...
    Object.defineProperty(
      AngularFontAwesomeComponent.prototype,
      'optionalClasses',
      {
        /**
         * @return {?}
     ...
     * @return {?}
     */
    AngularFontAwesomeComponent.prototype.addToOptionalClasses = function (
      addClass
    ) {
      ...
      args: [
        {
          selector: 'fa',
          template:
            '<i class="fa fa-{{ name }}" aria-hidden="true" [ngClass]="optionalClasses" ></i> ',
          styles: ['']
        }
      ]
    }
   ...
   * @nocollapse
   */
  AngularFontAwesomeComponent.ctorParameters = function () {
    return [];
  };
  ...
  AngularFontAwesomeService.decorators = [{ type: _angular_core.Injectable }];
  /**
   * @nocollapse
   */
  AngularFontAwesomeService.ctorParameters = function () {
    return [];
  };
   ...
   * \@experimental
   */
  var LOCATION_INITIALIZED = new _angular_core.InjectionToken(
  ...
  var LocationStrategy = (function () {
     ...
     * @return {?}
     */
    LocationStrategy.prototype.pushState = function (
      state,
      title,
      url,
      queryParams
     ...
     * @return {?}
     */
    LocationStrategy.prototype.replaceState = function (
      state,
      title,
      url,
      queryParams
  ...
  var Location = (function () {
    ...
    Location.prototype.isCurrentPathEqualTo = function (path, query) {
      ...
      return (
        this.path() ==
        this.normalize(path + Location.normalizeQueryParams(query))
      );
    };
    /**
  ...
  var HashLocationStrategy = (function (_super) {
    ...
    HashLocationStrategy.prototype.prepareExternalUrl = function (internal) {
      var /** @type {?} */ url = Location.joinWithSlash(
          this._baseHref,
          internal
        );
     ...
     * @return {?}
     */
    HashLocationStrategy.prototype.pushState = function (
      state,
      title,
      path,
      queryParams
    ) {
      var /** @type {?} */ url = this.prepareExternalUrl(
     ...
     * @return {?}
     */
    HashLocationStrategy.prototype.replaceState = function (
      state,
      title,
      path,
      queryParams
  ...
  var PathLocationStrategy = (function (_super) {
     ...
     * @return {?}
     */
    PathLocationStrategy.prototype.pushState = function (
      state,
      title,
      url,
      queryParams
    ) {
      var /** @type {?} */ externalUrl = this.prepareExternalUrl(
     ...
     * @return {?}
     */
    PathLocationStrategy.prototype.replaceState = function (
      state,
      title,
      url,
      queryParams
    ...
    return [
      {
        type: undefined,
        decorators: [
          { type: _angular_core.Inject, args: [_angular_core.LOCALE_ID] }
        ]
      }
    ];
  };
  ...
  function getPluralCase(locale, nLike) {
    ...
    var /** @type {?} */ t =
        parseInt(n.toString().replace(/^[^.]*\.?|0+$/g, ''), 10) || 0;
    ...
    switch (lang) {
      ...
      case 'br':
        if (
          n % 10 === 1 &&
          !(n % 100 === 11 || n % 100 === 71 || n % 100 === 91)
        )
          return Plural.One;
        if (
          n % 10 === 2 &&
          !(n % 100 === 12 || n % 100 === 72 || n % 100 === 92)
        )
          return Plural.Two;
        if (
          n % 10 === Math.floor(n % 10) &&
  ...
  var NgClass = (function () {
    ...
    NgClass.prototype.ngDoCheck = function () {
      if (this._iterableDiffer) {
        var /** @type {?} */ iterableChanges = this._iterableDiffer.diff(
            /** @type {?} */ (this._rawClass)
          );
        if (iterableChanges) {
        ...
        var /** @type {?} */ keyValueChanges = this._keyValueDiffer.diff(
            /** @type {?} */ (this._rawClass)
          );
        if (keyValueChanges) {
        ...
        if (typeof record.item === 'string') {
          ...
          throw new Error(
            'NgClass can only toggle CSS classes expressed as strings, got ' +
              _angular_core.ɵstringify(record.item)
          );
        }
      });
      changes.forEachRemovedItem(function (record) {
    ...
    NgClass.prototype._toggleClass = function (klass, enabled) {
      ...
      if (klass) {
        klass.split(/\s+/g).forEach(function (klass) {
          _this._renderer.setElementClass(
            _this._ngEl.nativeElement,
            klass,
            !!enabled
          );
        });
      ...
      if (this.ngComponentOutlet) {
        ...
        if (changes['ngComponentOutletNgModuleFactory']) {
          ...
          if (this.ngComponentOutletNgModuleFactory) {
            var /** @type {?} */ parentModule = elInjector.get(
        ...
        var /** @type {?} */ componentFactoryResolver = this._moduleRef
            ? this._moduleRef.componentFactoryResolver
            : elInjector.get(_angular_core.ComponentFactoryResolver);
        var /** @type {?} */ componentFactory = componentFactoryResolver.resolveComponentFactory(
    ...
    NgForOf.prototype._applyChanges = function (changes) {
      ...
      changes.forEachOperation(function (
        ...
        if (item.previousIndex == null) {
          var /** @type {?} */ view = _this._viewContainer.createEmbeddedView(
              _this._template,
              new NgForOfContext(
                /** @type {?} */ (null),
                _this.ngForOf,
          ...
          var /** @type {?} */ view = _this._viewContainer.get(
              adjustedPreviousIndex
            );
          _this._viewContainer.move(view, currentIndex);
          var /** @type {?} */ tuple = new RecordViewTuple(
              item,
              /** @type {?} */ (view)
            );
          insertTuples.push(tuple);
      ...
      for (
        var /** @type {?} */ i = 0,
          /** @type {?} */ ilen = this._viewContainer.length;
        i < ilen;
        i++
      ) {
      ...
      changes.forEachIdentityChange(function (record) {
        var /** @type {?} */ viewRef = _this._viewContainer.get(
            record.currentIndex
          );
  ...
  var NgPlural = (function () {
    ...
    NgPlural.prototype._updateView = function () {
      ...
      var /** @type {?} */ key = getPluralCategory(
          this._switchValue,
          cases,
          this._localization
        );
  ...
  NgPluralCase.ctorParameters = function () {
    return [
      {
        type: undefined,
        decorators: [{ type: _angular_core.Attribute, args: ['ngPluralCase'] }]
      },
      { type: _angular_core.TemplateRef },
      { type: _angular_core.ViewContainerRef },
  ...
  var ObservableStrategy = (function () {
     ...
     * @return {?}
     */
    ObservableStrategy.prototype.createSubscription = function (
      async,
      updateLatestValue
    ) {
  ...
  var PromiseStrategy = (function () {
     ...
     * @return {?}
     */
    PromiseStrategy.prototype.createSubscription = function (
      async,
      updateLatestValue
    ) {
  ...
  var AsyncPipe = (function () {
    ...
    AsyncPipe.prototype._subscribe = function (obj) {
      ...
      this._subscription = this._strategy.createSubscription(obj, function (
        value
      ) {
  ...
  var CurrencyPipe = (function () {
     ...
     * @return {?}
     */
    CurrencyPipe.prototype.transform = function (
      value,
      currencyCode,
      symbolDisplay,
      digits
  ...
  var DatePipe = (function () {
    ...
    DatePipe.prototype.transform = function (value, pattern) {
      ...
      if (!isDate(date)) {
        ...
        if (
          typeof value === 'string' &&
          (match = value.match(ISO8601_DATE_REGEX))
        ) {
      ...
      return DateFormatter.format(
        date,
        this._locale,
        DatePipe._ALIASES[pattern] || pattern
      );
    };
    return DatePipe;
  })();
  ...
  function isoStringToDate(match) {
    ...
    var /** @type {?} */ tzHour = 0;
    var /** @type {?} */ tzMin = 0;
    var /** @type {?} */ dateSetter = match[8]
        ? date.setUTCFullYear
        : date.setFullYear;
    var /** @type {?} */ timeSetter = match[8]
        ? date.setUTCHours
        : date.setHours;
    if (match[9]) {
    ...
    var /** @type {?} */ ms = Math.round(
        parseFloat('0.' + (match[7] || 0)) * 1000
      );
   ...
   * @nocollapse
   */
  AngularFontAwesomeModule.ctorParameters = function () {
    return [];
  };
