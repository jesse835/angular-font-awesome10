...
AngularFontAwesomeService.decorators = [{ type: Injectable }];
/**
 * @nocollapse
 */
...
var Location = (function () {
  ...
  Location.prototype.isCurrentPathEqualTo = function (path, query) {
    ...
    return (
      this.path() == this.normalize(path + Location.normalizeQueryParams(query))
    );
  };
  /**
...
NgClass.decorators = [{ type: Directive, args: [{ selector: '[ngClass]' }] }];
/**
 * @nocollapse
 */
    ...
    changes.forEachOperation(function (
      ...
      if (item.previousIndex == null) {
        var /** @type {?} */ view = _this._viewContainer.createEmbeddedView(
            _this._template,
            new NgForOfContext(/** @type {?} */ (null), _this.ngForOf, -1, -1),
            currentIndex
          );
...
NgIf.decorators = [{ type: Directive, args: [{ selector: '[ngIf]' }] }];
/**
 * @nocollapse
 */
...
NgSwitch.decorators = [{ type: Directive, args: [{ selector: '[ngSwitch]' }] }];
/**
 * @nocollapse
 */
...
NgPluralCase.ctorParameters = function () {
  return [
    {
      type: undefined,
      decorators: [{ type: Attribute, args: ['ngPluralCase'] }]
    },
    { type: TemplateRef },
    { type: ViewContainerRef },
...
NgStyle.decorators = [{ type: Directive, args: [{ selector: '[ngStyle]' }] }];
/**
 * @nocollapse
 */
...
TitleCasePipe.decorators = [{ type: Pipe, args: [{ name: 'titlecase' }] }];
/**
 * @nocollapse
 */
